...
<div className=" bg-cover bg-center h-auto lg:h-[1000px] 2xl:h-[1200px]  flex justify-center shadow-sm  lg:justify-start  min-h-screen" style={{ backgroundImage: `url(ASDEVUKHeroCollage.png)` }} >
       ...
       <div className=" text-center lg:pl-4 mb-[50px] " >
                 <h1 className='py-4 leading-[70px] lg:leading-[101px]  text-[50px] sm:text-[50px] lg:text-[92px] animate-pop-in abujaheroH1'>
                 Welcome to <br /> ASDEV81 <br /> Abuja Chapter
                 </h1>
                 <p className='py-4 text-[25px] sm:text-[25px] lg:text-[34px] animate-pop-in text-[white!important] asabaseptember'>
       Inauguared in May 1995.
          </p>
      ...
      <div className="px-8 mx-auto lg:mx-[100px] py-20">
        <div className="flex justify-start 2xl:ml-[100px] mx-auto">
          ...
          <h1 className='ASDEV81'>
            <span className='commitment'>ASDEV81  Club Abuja Chapter <br /> commitment to the Club is to <br /></span>
    ...
    <div className="">
      <h1 className='national py-8'>The Abuja Executive</h1>
           {/* 1 grid */}
...
rotate: 0,
         ...
         <LazyLoadImage className='w-[80px] h-[80px] rounded-full shadow-2xl z-50' src={'OSAJI_80X80.png'} alt="" />
          ...
          <LazyLoadImage className='w-[80px] h-[80px]shadow-2xl z-50'src={'ASDEV81_LOGO.png'} alt="" />
            <div className="mx-4 ">
              <p className='Og'>MR NNAMDI GREG ALEX OSAJI</p>
        ...
        <motion.div
         ...
         <LazyLoadImage className='w-[80px] h-[80px] rounded-full shadow-2xl z-50' src={'VictorHeadshot.jpg'} alt="" />
          ...
          <LazyLoadImage className='w-[80px] h-[80px]shadow-2xl z-50'src={'ASDEV81_LOGO.png'} alt="" />
            <div className="mx-4 ">
              <p className='Og'>MR MENIRU G. ONYIA</p>
        ...
        whileHover={{
         ...
         <LazyLoadImage className='w-[80px] h-[80px] rounded-full shadow-2xl z-50' src={'VictorHeadshot.jpg'} alt="" />
          ...
          <LazyLoadImage className='w-[80px] h-[80px]shadow-2xl z-50'src={'ASDEV81_LOGO.png'} alt="" />
            <div className="mx-4 ">
              <p className='Og'>OGBUESHI CHRIS UGBOKO</p>
       ...
       <LazyLoadImage className='w-[80px] h-[80px] rounded-full shadow-2xl z-50' src={'VictorHeadshot.jpg'} alt="" />
          ...
          <LazyLoadImage className='w-[80px] h-[80px]shadow-2xl z-50'src={'ASDEV81_LOGO.png'} alt="" />
            <div className="mx-4 ">
              <p className='Og'>MR EMEKA V. OKOLIE</p>
        ...
        <motion.div
         whileHover={{
          ...
          <LazyLoadImage className='w-[80px] h-[80px]shadow-2xl z-50'src={'ASDEV81_LOGO.png'} alt="" />
            <div className="mx-4 ">
              <p className='Og'>MR MICHAEL NWOKOLO</p>
              <p className='president'>SOCIAL & PUBLICITY SECRETARY</p>
            </div>
             </div>
        </motion.div>
...
<motion.div
         whileHover={{
          ...
          <LazyLoadImage className='w-[80px] h-[80px]shadow-2xl z-50'src={'ASDEV81_LOGO.png'} alt="" />
            <div className="mx-4 ">
              <p className='Og'>SIR FRANK ONWUDINJO</p>
        ...
        <motion.div
         whileHover={{
          ...
          <LazyLoadImage className='w-[80px] h-[80px]shadow-2xl z-50'src={'ASDEV81_LOGO.png'} alt="" />
            <div className="mx-4 ">
              <p className='Og'>MR ALEX OKWUOBI</p>
              <p className='president'>PROVOST</p>
            </div>
             </div>
        </motion.div>
  ...
  <div className="">
    ...
    <div className="bg-[#F7F9FA] mt-5 p-5">
      ...
      <div className="px-8 exasaba lg:px-[120px] pb-[100px] bg-[#3E4345] py-10">
        ...
        <p className='below py-4 text-[25px] sm:text-[34px]'>Show your interest in joining ASDEV81 Club Abuja Chapter by <br />
