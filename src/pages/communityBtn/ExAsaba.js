...
<div className="bg-cover bg-center h-auto lg:h-[1400px] 2xl:h-[1600px]  flex justify-center shadow-sm  lg:justify-start  min-h-screen"  style={{ backgroundImage: `url(ASDEVUKHeroCollage.png)` }}>
       ...
       <div className="text-center lg:pl-4 mb-[50px] " >
                 <h1 className='py-4 leading-[70px] lg:leading-[101px]  text-[50px] sm:text-[50px] lg:text-[92px] animate-pop-in AsabaheroH1'>
                 Welcome to <br /> ASDEV81 <br /> Asaba Chapter
                 </h1>
                 <p className='py-4 text-[25px] text-[white!important] sm:text-[25px] lg:text-[34px] animate-pop-in asabaseptember'>
                 Inauguared in April 1997.
          </p>
      ...
      <div className="px-8 mx-auto lg:mx-[100px] py-20">
        <div className="flex justify-start 2xl:ml-[100px] mx-auto">
          ...
          <h1 className='ASDEV81'>
            <span className='commitment'>ASDEV81  Club Asaba Chapter <br /> commitment to the Club is to <br /></span>
        ...
        <div className="py-10 grid  grid-cols-1 lg:grid-cols-2 gap-4 mx-auto ">
          ...
          <div className="">
            <h1 className='national py-8'>The Asaba Executive</h1>
                 {/* 1 grid */}
    ...
    rotate: 0,
               ...
               <LazyLoadImage className='w-[80px] h-[80px] rounded-full shadow-2xl z-50' src={'IYIO_80X80.jpg'} alt="" />
                ...
                <LazyLoadImage className='w-[80px] h-[80px]shadow-2xl z-50'src={'ASDEV81_LOGO.png'} alt="" />
                  <div className="mx-4 ">
                    <p className='Og'>MR OBIAJULU NELSON IYIO</p>
             ...
             <LazyLoadImage className='w-[80px] h-[80px] rounded-full shadow-2xl z-50' src={'OYIANYA.png'} alt="" />
              ...
              <motion.div
               whileHover={{
                ...
                <LazyLoadImage className='w-[80px] h-[80px]shadow-2xl z-50'src={'ASDEV81_LOGO.png'} alt="" />
                  <div className="mx-4 ">
                    <p className='Og'>OGBUESHI RICHIE OMO</p>
...
<motion.div
      ...
      <div className="px-8 exasaba lg:px-[120px] pb-[100px] bg-[#3E4345] py-10">
        ...
        <p className='below py-4 text-[25px] sm:text-[34px]'>Show your interest in joining ASDEV81 Club Asaba Chapter by <br />
