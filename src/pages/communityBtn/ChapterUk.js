      ...
      <div className="px-8 mx-auto lg:mx-[100px] py-20">
        <div className="flex justify-start 2xl:ml-[100px] mx-auto">
          ...
          <h1 className='ASDEV81'>
            <span className='commitment'>ASDEV81  Club UK Chapter <br /> commitment to the Club is to <br /></span>
           ...
           {/* 3 */}
              <motion.div
               whileHover={{
                ...
                <LazyLoadImage className='w-[80px] h-[80px]shadow-2xl z-50'src={'ASDEV81_LOGO.png'} alt="" />
                  <div className="mx-4 ">
                    <p className='Og'>OGBUESI PATRICK IJEH</p>
              ...
              <motion.div
               whileHover={{
                ...
                <LazyLoadImage className='w-[80px] h-[80px]shadow-2xl z-50'src={'ASDEV81_LOGO.png'} alt="" />
                  <div className="mx-4 ">
                    <p className='Og'>OGBUESI KEN GWAM</p>
              ...
              <motion.div
               whileHover={{
                ...
                <LazyLoadImage className='w-[80px] h-[80px]shadow-2xl z-50'src={'ASDEV81_LOGO.png'} alt="" />
                  <div className="mx-4 ">
                    <p className='Og'>OGBUESI VICTOR CHUKWURAH</p>
                    <p className='president'>EX-OFFICIO</p>
                  </div>
                   </div>
