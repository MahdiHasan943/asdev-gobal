...
<div className="bg-cover bg-center h-auto lg:h-[1400px] 2xl:h-[1600px]  flex justify-center shadow-sm  lg:justify-start  min-h-screen"  style={{ backgroundImage: `url(ASDEVUKHeroCollage.png)` }}>
       ...
       <div className="text-center lg:pl-4 mb-[50px] " >
                 <h1 className='py-4 leading-[70px] lg:leading-[101px]  text-[50px] sm:text-[50px] lg:text-[92px] animate-pop-in lagosheroH1'>
                 Welcome to <br /> ASDEV81 <br /> Lagos Chapter
                 </h1>
                 <p className='py-4 text-[white!important] text-[25px] sm:text-[25px] lg:text-[34px] animate-pop-in asabaseptember'>
       Inaugurated in August 1993.
          </p>
...
{/* 
<div className="flex justify-center shadow-sm  lg:justify-start  min-h-screen"  style={{ backgroundImage: `url()` }}>
      ...
      <div className="px-8 mx-auto lg:mx-[100px] py-20">
        <div className="flex justify-start 2xl:ml-[100px] mx-auto">
          ...
          <h1 className='ASDEV81'>
            <span className='commitment'>ASDEV81  Club Lagos Chapter <br /> commitment to the Club is to <br /></span>
    ...
    <div className="">
      <h1 className='national py-8'>The Lagos Executive</h1>
           {/* 1 grid */}
...
rotate: 0,
        ...
        <LazyLoadImage className='w-[80px] h-[80px] rounded-full shadow-2xl z-50' src={'IKEDIASHI_80X80.jpg'} alt="" />
          ...
          <LazyLoadImage className='w-[80px] h-[80px]shadow-2xl z-50'src={'ASDEV81_LOGO.png'} alt="" />
            <div className="mx-4 ">
              <p className='Og'>MR PATRICK IKEDIASHI</p>
        ...
        <motion.div
          ...
          <LazyLoadImage className='w-[80px] h-[80px]shadow-2xl z-50'src={'ASDEV81_LOGO.png'} alt="" />
            <div className="mx-4 ">
              <p className='Og'>MR ANTHONY OKWURAIWE</p>
        ...
        <LazyLoadImage className='w-[80px] h-[80px] rounded-full shadow-2xl z-50' src={'VictorHeadshot.jpg'} alt="" />
          ...
          <LazyLoadImage className='w-[80px] h-[80px]shadow-2xl z-50'src={'ASDEV81_LOGO.png'} alt="" />
            <div className="mx-4 ">
              <p className='Og'>MR NNAMDI UGBOKO</p>
      ...
      <LazyLoadImage className='w-[80px] h-[80px] rounded-full shadow-2xl z-50' src={'VictorHeadshot.jpg'} alt="" />
          ...
          <LazyLoadImage className='w-[80px] h-[80px]shadow-2xl z-50'src={'ASDEV81_LOGO.png'} alt="" />
            <div className="mx-4 ">
              <p className='Og'>MR ELOKA IDIGBE</p>
        ...
        <motion.div
         whileHover={{
          ...
          <LazyLoadImage className='w-[80px] h-[80px]shadow-2xl z-50'src={'ASDEV81_LOGO.png'} alt="" />
            <div className="mx-4 ">
              <p className='Og'>MR CHILDREN NWAJEI</p>
  ...
  <motion.div
         whileHover={{
          ...
          <LazyLoadImage className='w-[80px] h-[80px]shadow-2xl z-50'src={'ASDEV81_LOGO.png'} alt="" />
            <div className="mx-4 ">
              <p className='Og'>MR GREG CHICHI</p>
              <p className='president'>WELFARE SECRETARY</p>
            </div>
             </div>
        </motion.div>
        ...
        <motion.div
         whileHover={{
          ...
          <LazyLoadImage className='w-[80px] h-[80px]shadow-2xl z-50'src={'ASDEV81_LOGO.png'} alt="" />
            <div className="mx-4 ">
              <p className='Og'>MR ALFRED OKONKWO</p>
  ...
  <div className="">
    ...
    <div className="bg-[#F7F9FA] mt-5 p-5">
      ...
      <div className="px-8 exasaba lg:px-[120px] pb-[100px] bg-[#3E4345] py-10">
        ...
        <p className='below py-4 text-[25px] sm:text-[34px]'>Show your interest in joining ASDEV81 Club Lagos Chapter by <br />
