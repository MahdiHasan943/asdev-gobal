...
const Community = () => {
  ...
  return (
    ...
    rotate: 0,
               ...
               <LazyLoadImage className='w-[80px] h-[80px] rounded-full shadow-2xl z-50' src={'ALLANAH_80X80.jpg'} alt="" />
              ...
              <motion.div
                ...
                className="bg bgHover py-12 px-6">
                <LazyLoadImage className='w-[80px] h-[80px] rounded-full shadow-2xl z-50' src={'ELUAKA_80X80.jpg'} alt="" />
             ...
             <LazyLoadImage className='w-[80px] h-[80px] rounded-full shadow-2xl z-50' src={'EMMADIALI_80X80.jpg'} alt="" />
              ...
              <motion.div
               whileHover={{
                ...
                <LazyLoadImage className='w-[80px] h-[80px]shadow-2xl z-50'src={'ASDEV81_LOGO.png'} alt="" />
                  <div className="mx-4 ">
                    <p className='Og'>MR ANTHONY CHIEDU CHUKWURAH</p>
...
<motion.div
              ...
              <motion.div
               whileHover={{
                ...
                <LazyLoadImage className='w-[80px] h-[80px]shadow-2xl z-50'src={'ASDEV81_LOGO.png'} alt="" />
                  <div className="mx-4 ">
                    <p className='Og'>OGBUESI BARRISTER MARK ANTHONY NDUKAEZE</p>
